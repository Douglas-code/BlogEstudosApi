...
namespace BlogEstudos.Controllers
{
    ...
    public class PublicacaoController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllPublicacoes(int usuarioId)
        {
            try
            {
                var publicacoes = await _publicacaoService.SelectPublicacoes(usuarioId);
